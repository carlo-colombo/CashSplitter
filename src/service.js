angular.module('CashSplitter.service', ['CashSplitter.views']).provider('TripService', [
  'views',
  function (views) {
      ...
      $get: [
        ...
        function ($q) {
          ...
          return {
            ...
            list: function () {
              return wrap(db.allDocs({ include_docs: true }));
            },
            destroy: function () {
            ...
            getEntry: function (entry_id) {
              return wrap(db.query(views.entries)).then(function (entries) {
                return entries.rows;
              }).then(function (entries) {
                return _.find(entries, { key: entry_id });
              }).then(function (entry) {
                return entry.value;
              });
            }
